...
contract MuteSwitchERC20Dynamic is EIP712 {
    ...
    constructor() EIP712(name, "1") {} // solhint-disable-line no-empty-blocks
    ...
    function permit(address owner, address spender, uint256 value, uint256 deadline, bytes memory sig) external {
        require(block.timestamp <= deadline, "MuteSwitchERC20: expired deadline"); // solhint-disable-line reason-string
        ...
        require(success, "MuteSwitchERC20: INVALID_SIGNATURE"); // solhint-disable-line reason-string
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = _safe32(block.number, "Gov::_writeCheckpoint: block number exceeds 32 bits");
    ...
    function getPriorVotes(address account, uint blockNumber) public view returns (uint256) {
        require(blockNumber < block.number, "dSoulBound::getPriorVotes: not yet determined"); // solhint-disable-line reason-string
